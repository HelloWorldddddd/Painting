...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "024df79d"; //在控制台-我的应用获取
	private static final String apiSecret = "YjEzODE5YWUxODQwNWVkNDY5MTE2ZWJl"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "cacc8669d2104cab4e56c6775e521ff0"; //在控制台-我的应用-语音听写（流式版）获取
